...
| **2. Sealed Secrets** ⬅️ **แนะนำ** | ไฟล์ที่เข้ารหัสแล้ว commit ลง git ได้อย่างปลอดภัย, มี version, GitOps ครบวงจร, ไม่ต้องพึ่งบริการภายนอก, ติดตั้งบน k3s ได้ใน 5 นาที | ต้อง backup คีย์ของ controller เอง, ถอดรหัสได้เฉพาะในคลัสเตอร์นั้น | โปรเจกต์ขนาดนี้ |
...
ซึ่งเป็นสิ่งที่คนทำแล้วพลาดซ้ำได้เสมอ และเข้ากับ k3s ที่ใช้อยู่โดยไม่ต้องพึ่งบริการภายนอก
